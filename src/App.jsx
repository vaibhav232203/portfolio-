...
import img1 from "../public/img/blackfriday.jpg"
import img2 from "../public/img/aariyaprimix.png"
import img3 from "../public/img/viraevent.png"
          ...
          >
            <motion.div variants={itemVariants} whileHover={{ y: -6 }} className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl overflow-hidden shadow-xl flex flex-col group transition-all duration-300 hover:border-zinc-700/80 backdrop-blur-sm">
              <div className="relative h-44 overflow-hidden bg-zinc-950">
                <img src={img1} alt="E-commerce Portal" className="w-full h-full object-cover opacity-30 grayscale group-hover:opacity-50 group-hover:scale-105 group-hover:grayscale-0 transition-all duration-500" />
              </div>
            ...
            <motion.div variants={itemVariants} whileHover={{ y: -6 }} className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl overflow-hidden shadow-xl flex flex-col group transition-all duration-300 hover:border-zinc-700/80 backdrop-blur-sm">
              <div className="relative h-44 overflow-hidden bg-zinc-950">
                <img src={img2} alt="Management Portal" className="w-full h-full opacity-30 grayscale group-hover:opacity-50 group-hover:scale-105 group-hover:grayscale-0 transition-all duration-500" />
              </div>
              <div className="p-6 flex flex-col flex-grow">
            ...
            <motion.div variants={itemVariants} whileHover={{ y: -6 }} className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl overflow-hidden shadow-xl flex flex-col group transition-all duration-300 hover:border-zinc-700/80 backdrop-blur-sm">
              <div className="relative h-44 overflow-hidden bg-zinc-950">
                <img src={img3} alt="Event Planning System" className="w-full h-full object-cover opacity-30 grayscale group-hover:opacity-50 group-hover:scale-105 group-hover:grayscale-0 transition-all duration-500" />
              </div>
              <div className="p-6 flex flex-col flex-grow">
